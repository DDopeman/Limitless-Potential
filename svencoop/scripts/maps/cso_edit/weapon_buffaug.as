...
const float CSOW_SPREAD_JUMPING				= 0.020;
const float CSOW_SPREAD_RUNNING				= 0.015;
const float CSOW_SPREAD_WALKING				= 0.015;
const float CSOW_SPREAD_STANDING				= 0.015;
const float CSOW_SPREAD_DUCKING				= 0.01;
...
const Vector CSOW_OFFSETS_SHELL				= Vector( 20.245131, -7.099761, -4.173389 ); //forward, right, up
...
const string MODEL_VIEW								= "models/cso_edit/buffaug/v_buffaug.mdl";
const string MODEL_PLAYER							= "models/cso_edit/buffaug/p_buffaug.mdl";
const string MODEL_WORLD							= "models/cso_edit/buffaug/w_buffaug.mdl";
const string MODEL_SHELL							= "models/cso_edit/rshell.mdl";
const string MODEL_AMMO								= "models/cso_edit/buffaug/w_buffaugclip.mdl";
...
{
	"cso_edit/dryfire_rifle.wav",  //only here for the precache
	"cso_edit/buffaug/buffaug-1.wav",
	"cso_edit/buffaug/buffaug-1.wav",
	"cso_edit/buffaug/magout.wav",
	"cso_edit/buffaug/magin.wav",
};

class weapon_buffaug : CBaseCSOWeapon
{
	...
	void Precache()
	{
		...
		g_Game.PrecacheGeneric( "sprites/cso_edit/640hud166.spr" );
	...
	void PrimaryAttack()
	{
		...
		if( !USE_CSLIKE_RECOIL )
		{
			...
			HandleRecoil( CSOW_RECOIL_STANDING_X * 0.2, CSOW_RECOIL_STANDING_Y * 0.2, CSOW_RECOIL_DUCKING_X * 0.2, CSOW_RECOIL_DUCKING_Y * 0.2 );
...
class ammo_cso_buffaug : ScriptBasePlayerAmmoEntity
{
	void Spawn()
	{ 
	...
	{ 
		...
		if( pOther.GiveAmmo( iGive, "cso_buffaugammo", CSOW_MAX_AMMO ) != -1)
		{
...
void Register()
{
	...
	g_CustomEntityFuncs.RegisterCustomEntity( "cso_buffaug::ammo_cso_buffaug", "ammo_cso_buffaug" );
	g_CustomEntityFuncs.RegisterCustomEntity( "cso_buffaug::weapon_buffaug", CSOW_NAME );
	g_ItemRegistry.RegisterWeapon( CSOW_NAME, "cso_edit", "cso_buffaugammo", "", "ammo_cso_buffaug" ); //"762mg", "", "ammo_762mg"
}

} //namespace cso_buffaug END