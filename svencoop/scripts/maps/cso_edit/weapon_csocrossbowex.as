namespace cso_crossbowex
{

	const string CSOW_NAME = "weapon_csocrossbowex";
	...
	const string MODEL_VIEW = "models/cso_edit/skins/crossbow/v_crossbowex.mdl";
	const string MODEL_VIEW_SCOPE = "models/cso_edit/v_crossbow_scope.mdl";
	const string MODEL_PLAYER = "models/cso_edit/skins/crossbow/p_crossbowex.mdl";
	const string MODEL_WORLD = "models/cso_edit/skins/crossbow/w_crossbowex.mdl";
	const string MODEL_BOLT = "models/cso_edit/crossbow_bolt.mdl";
	...
	const array<string> pCSOWSounds =
		{
			...
			"cso_edit/crossbow-1.wav",
			"cso_edit/xbow_hit1.wav",
			"cso_edit/xbow_hitbod1.wav",
			"cso_edit/crossbow_draw.wav",
			"cso_edit/crossbow_foley1.wav",
			"cso_edit/crossbow_foley2.wav",
			"cso_edit/crossbow_foley3.wav",
			"cso_edit/crossbow_foley4.wav",
			"cso_edit/crossbowex_draw.wav" // uncomment this line if using the advance (ex) skin
	};

	class weapon_csocrossbowex : CBaseCSOWeapon
	{
		void Spawn()
		{
			Precache();
		...
		void Precache()
		{
			...
			g_Game.PrecacheGeneric("sprites/cso_edit/640hud44.spr");
		...
		bool GetItemInfo(ItemInfo& out info)
		{
			...
			info.iSlot = cso::CSOCROSSBOW_SLOT;
			info.iPosition = cso::CSOCROSSBOW_POSITION;
	...
	class CSO_BOLTS : ScriptBasePlayerAmmoEntity
	{
		void Spawn()
		{
			g_EntityFuncs.SetModel(self, cso::MODEL_CSOBOLTS);
		...
		bool AddAmmo(CBaseEntity @pOther)
		{
			...
			if (pOther.GiveAmmo(iGive, "csobolts", CSOW_MAX_AMMO) != -1)
			{
	...
	string GetAmmoName()
	{
		return "ammo_csocrossbowex";
	}

	void Register()
	{
		g_CustomEntityFuncs.RegisterCustomEntity("cso_crossbowex::csobolt", "csobolt");
		g_CustomEntityFuncs.RegisterCustomEntity("cso_crossbowex::weapon_csocrossbowex", CSOW_NAME);
		g_CustomEntityFuncs.RegisterCustomEntity("cso_crossbowex::CSO_BOLTS", GetAmmoName());
		g_ItemRegistry.RegisterWeapon(CSOW_NAME, "cso_edit", "csobolts", "", "ammo_csobolts");
