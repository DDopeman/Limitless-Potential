...
const float CSOW_ROCKET_SPEED					= 2048;
const float CSOW_ROCKET_RADIUS				= 400;
...
const string MODEL_VIEW								= "models/cso_edit/at4ex/v_at4ex.mdl";
const string MODEL_VIEW_SCOPE					= "models/cso_edit/at4ex/v_at4ex_scope.mdl"; //v_crossbow_scope
const string MODEL_PLAYER							= "models/cso_edit/at4ex/p_at4ex.mdl";
const string MODEL_WORLD							= "models/cso_edit/at4ex/w_at4ex.mdl";
const string MODEL_ROCKET							= "models/cso_edit/rpgrocket.mdl";
...
const array<string> pCSOWSounds =
{
	...
	"cso_edit/at4-1.wav",
	"cso_edit/at4_clipin1.wav",
	"cso_edit/at4_clipin2.wav",
	"cso_edit/at4_clipin3.wav",
	"cso_edit/at4_draw.wav"
};
...
class weapon_at4ex : CBaseCSOWeapon
{
	...
	void Precache()
	{
		...
		g_Game.PrecacheGeneric( "sprites/cso_edit/640hud53.spr" );
	}
...
class at4exrocket : ScriptBaseEntity
{
	...
	void RocketTouch( CBaseEntity@ pOther )
	{
		...
		NetworkMessage m2( MSG_PVS, NetworkMessages::SVC_TEMPENTITY, vecOrigin );
			...
			m2.WriteCoord( vecOrigin.z + 64 );
			m2.WriteShort( g_EngineFuncs.ModelIndex(SPRITE_EXPLOSION2) );
			m2.WriteByte( 35 ); // scale * 10
			m2.WriteByte( 20 ); // framerate
			m2.WriteByte( TE_EXPLFLAG_NODLIGHTS|TE_EXPLFLAG_NOSOUND|TE_EXPLFLAG_NOPARTICLES );
		m2.End();
		...
		NetworkMessage m3( MSG_PVS, NetworkMessages::SVC_TEMPENTITY, vecOrigin );
			...
			m3.WriteByte( 10 ); // framerate
		m3.End();

		g_WeaponFuncs.RadiusDamage( pev.origin, self.pev, pev.owner.vars, pev.dmg, CSOW_ROCKET_RADIUS, CLASS_NONE, DMG_LAUNCH );
...
void Register()
{
	...
	g_ItemRegistry.RegisterWeapon( CSOW_NAME, "cso_edit", "rockets", "", "ammo_rpgclip" );
}
