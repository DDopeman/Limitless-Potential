...
const float CSOW_TIME_DRAW					= 0.89; //1.0
...
const string MODEL_VIEW							= "models/cso_edit/v_plasmagun.mdl";
const string MODEL_PLAYER						= "models/cso_edit/p_plasmagun.mdl";
const string MODEL_WORLD						= "models/cso_edit/w_plasmagun.mdl";
const string MODEL_AMMO						= "models/cso_edit/plasmashell.mdl";

const string SPRITE_PLASMA						= "sprites/cso_edit/plasmaball.spr";
const string SPRITE_EXPLODE					= "sprites/cso_edit/plasmabomb.spr";
...
const array<string> pCSOWSounds =
{
	...
	"cso_edit/plasmagun_idle.wav",	
	"cso_edit/plasmagun-1.wav",
	"cso_edit/plasmagun_exp.wav",
	"cso_edit/plasmagun_clipin1.wav",
	"cso_edit/plasmagun_clipin2.wav",
	"cso_edit/plasmagun_clipout.wav",
	"cso_edit/plasmagun_draw.wav"
};
...
class weapon_plasmagun : CBaseCSOWeapon
{
	...
	void PrimaryAttack()
	{
		...
		Vector vecVelocity = g_Engine.v_forward * CSOW_PLASMA_SPEED + g_Engine.v_right * -7.5 + g_Engine.v_up * 5.0;
		...
		{
		self.m_flNextPrimaryAttack = self.m_flNextSecondaryAttack = self.m_flNextTertiaryAttack = g_Engine.time + CSOW_TIME_DELAY * 1.25;
		self.m_flTimeWeaponIdle = g_Engine.time + CSOW_TIME_FIRE_TO_IDLE;
...
void Register()
{
	...
	g_ItemRegistry.RegisterWeapon( "weapon_plasmagun", "cso_edit", "plasma", "", "ammo_plasmashell" );
