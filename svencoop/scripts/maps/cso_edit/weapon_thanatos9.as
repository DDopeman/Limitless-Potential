...
const string MODEL_VIEW				= "models/cso_edit/v_thanatos9.mdl";
const string MODEL_PLAYER_MODEA		= "models/cso_edit/p_thanatos9a.mdl";
const string MODEL_PLAYER_MODEB		= "models/cso_edit/p_thanatos9b.mdl";
const string MODEL_PLAYER_MODEC		= "models/cso_edit/p_thanatos9c.mdl";
const string MODEL_WORLD			= "models/cso_edit/w_thanatos9.mdl";
...
{
	"cso_edit/thanatos9_shoota1.wav",
	"cso_edit/thanatos9_shoota2.wav",
	"cso_edit/thanatos9_shootb_end.wav",
	"cso_edit/thanatos9_shootb_loop.wav",
	"cso_edit/thanatos9_drawa.wav",
	"cso_edit/thanatos9_changea_1.wav",
	"cso_edit/thanatos9_changea_2.wav",
	"cso_edit/thanatos9_changea_3.wav",
	"cso_edit/thanatos9_changea_4.wav",
	"cso_edit/thanatos9_changeb_1.wav",
	"cso_edit/thanatos9_changeb_2.wav",
	"cso_edit/mastercombat_hit1.wav",
	"cso_edit/nata_wall.wav",
	"cso_edit/tomahawk_wall.wav"
};
...
class weapon_thanatos9 : CBaseCSOWeapon
{
	...
	void Precache()
	{
		...
		g_SmokePuff_SprId = g_Game.PrecacheModel( "sprites/cso_edit/smoke_thanatos9.spr" );
		...
		g_Game.PrecacheGeneric( "sprites/cso_edit/weapon_thanatos9.txt" );
		g_Game.PrecacheGeneric( "sprites/cso_edit/640hud79.spr" );
	}
...
void Register()
{
	...
	g_ItemRegistry.RegisterWeapon( "weapon_thanatos9", "cso_edit" );
