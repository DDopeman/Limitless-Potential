namespace cso
{
	...
	// Ammo
	const string MODEL_45ACP = "models/cso_edit/w_45acp.mdl";
	const string MODEL_57MM = "models/w_9mmclip.mdl";
	const string MODEL_50BMG = "models/cso_edit/w_50bmg.mdl";
	const string MODEL_762MG = "models/cso_edit/cs16/w_762natobox_big.mdl";
	const string MODEL_GASOLINE = "models/hunger/w_gas.mdl";
	const string MODEL_ETHER = "models/cso_edit/ethereal/w_etherammo.mdl";
	const string MODEL_CSOBOLTS = "models/cso_edit/mag_csocrossbow.mdl";

	const int MAXCARRY_45ACP = 600;
	const int GIVE_45ACP = 12;

	const int MAXCARRY_57MM = 500;
	const int GIVE_57MM = 50;

	const int MAXCARRY_BMG50 = 500;
	const int GIVE_BMG50 = 10;

	const int MAXCARRY_GASOLINE = 600;
	const int GIVE_GASOLINE = 50;

	const int MAXCARRY_ETHER = 300;
