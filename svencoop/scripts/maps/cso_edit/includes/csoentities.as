...
namespace cso
{
	...
	// Hitconfirm
	const string SPRITE_HITMARKER = "sprites/cso_edit/buffhit.spr";

	// Gundrop Effect
	const string CSO_ITEMDISPLAY_MODEL = "models/cso_edit/ef_gundrop.mdl";
	...
	class csoproj_flame : ScriptBaseEntity
	{
		...
		void Spawn()
		{
			...
			g_EntityFuncs.SetModel(self, "sprites/cso_edit/flame_puff01.spr");
		...
		void Precache()
		{
			g_Game.PrecacheModel("sprites/cso_edit/flame_puff01.spr");
		}
