...
const int CSOW_MAX_AMMO							= 480;
const int CSOW_TRACERFREQ							= 0;
const float CSOW_DAMAGE								= 45;
const float CSOW_SKILL_RADIUS_FAR				= cso::MetersToUnits(7);
const float CSOW_SKILL_RADIUS_CLOSE			= cso::MetersToUnits(4);
const float CSOW_SKILL_DAMAGE_FAR			= 200; //default 99
const float CSOW_SKILL_DAMAGE_CLOSE		= 200; //default 109
const float CSOW_SKILL_KNOCKBACK				= 20;
const float CSOW_TIME_DELAY1						= 0.070; //between shots
const float CSOW_TIME_DELAY2						= 0.35; //between switching hands
const float CSOW_TIME_DELAY3						= 0.18; //SecondaryAttack
...
const float CSOW_SPREAD_JUMPING				= 0.015; //0.20
const float CSOW_SPREAD_RUNNING				= 0.015; //0.15
const float CSOW_SPREAD_WALKING				= 0.015; //0.1
const float CSOW_SPREAD_STANDING				= 0.001;
const float CSOW_SPREAD_DUCKING				= 0;
...
const string MODEL_VIEW					= "models/cso_edit/gunkata/v_gunkata.mdl";
const string MODEL_PLAYER1				= "models/cso_edit/gunkata/p_gunkata.mdl";
//const string MODEL_PLAYER2			= "models/cso_edit/gunkata/p_gunkata2.mdl";
const string MODEL_WORLD				= "models/cso_edit/gunkata/w_gunkata.mdl";
const string MODEL_GUNKATA				= "models/cso_edit/gunkata/ef_gunkata.mdl";
const string MODEL_BLAST				= "models/cso_edit/ef_scorpion_hole.mdl";
const string MODEL_SHADOW_MAN			= "models/cso_edit/gunkata/ef_gunkata_man.mdl";
const string MODEL_SHADOW_WOMAN			= "models/cso_edit/gunkata/ef_gunkata_woman.mdl";
const string MODEL_SHELL				= "models/cso_edit/pshell.mdl";
const string MODEL_AMMO					= "models/cso_edit/gunkata/w_gunkata_ammo.mdl";
...
{
	"cso_edit/dryfire_pistol.wav", //only here for the precache
	"cso_edit/gunkata-1.wav",
	//"cso_edit/gunkata_idle.wav", //unused atm, way too loud imo
	"cso_edit/gunkata_skill_01.wav",
	"cso_edit/gunkata_skill_02.wav",
	"cso_edit/gunkata_skill_03.wav",
	"cso_edit/gunkata_skill_04.wav",
	"cso_edit/gunkata_skill_05.wav",
	"cso_edit/gunkata_skill_last_exp.wav",
	"cso_edit/turbulent9_hit1.wav", //make sure these are the correct sounds ??
	"cso_edit/turbulent9_hit2.wav",
	"cso_edit/gunkata_skill_last.wav",
	"cso_edit/gunkata_draw.wav",
	"cso_edit/gunkata_draw2.wav",
	"cso_edit/gunkata_reload.wav",
	"cso_edit/gunkata_reload2.wav"
};
...
class weapon_gunkata : CBaseCSOWeapon
{
	...
	void Precache()
	{
		...
		g_Game.PrecacheModel( "sprites/cso_edit/muzzleflash77.spr" );
		...
		g_Game.PrecacheGeneric( "sprites/cso_edit/640hud176.spr" );
	}
	...
	void PrimaryAttack()
	{
		if( m_pPlayer.pev.waterlevel == WATERLEVEL_HEAD or self.m_iClip <= 0 )
		{
			...
			self.PlayEmptySound();
			self.m_flNextPrimaryAttack = self.m_flNextSecondaryAttack = g_Engine.time + 0.10;
			return;
		}
		...
		FireBullets3( m_pPlayer.GetGunPosition(), g_Engine.v_forward, GetWeaponSpread() * 0.5, iPenetration, BULLET_PLAYER_44MAG, CSOW_TRACERFREQ, flDamage, 1.0, (CSOF_ALWAYSDECAL | CSOF_HITMARKER) );
		...
		self.m_flTimeWeaponIdle = g_Engine.time + flDelay + 0.4;
...
class ammo_gunkata : ScriptBasePlayerAmmoEntity
{
	void Spawn()
	{ 
	...
	{ 
		...
		if( pOther.GiveAmmo( iGive, "cso_gunkataammo", CSOW_MAX_AMMO ) != -1)
		{
...
void Register()
{
	...
	g_CustomEntityFuncs.RegisterCustomEntity( "cso_gunkata::ammo_gunkata", "ammo_gunkata" );
	g_CustomEntityFuncs.RegisterCustomEntity( "cso_gunkata::weapon_gunkata", CSOW_NAME );
	g_ItemRegistry.RegisterWeapon( CSOW_NAME, "cso_edit", "cso_gunkataammo", "", "ammo_gunkata" ); //44MAG
}
