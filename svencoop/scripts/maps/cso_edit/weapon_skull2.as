...
const string CSOW_MODEL_VIEW		= "models/cso_edit/v_skull2.mdl";
const string CSOW_MODEL_PLAYER		= "models/cso_edit/p_skull2.mdl";
const string CSOW_MODEL_PLAYER_DUAL	= "models/cso_edit/p_skull2dual.mdl";
const string CSOW_MODEL_WORLD		= "models/cso_edit/w_skull2.mdl";
const string CSOW_MODEL_SHELL		= "models/cso_edit/shell_skull1.mdl";
const string CSOW_MODEL_CLIP		= "models/cso_edit/clip_skull1.mdl";
...
{
	"cso_edit/cs16/dryfire_pistol.wav", //only here for the precache
	"cso_edit/skull2-1.wav",
	"cso_edit/skull2_clipin.wav",
	"cso_edit/skull2_clipout.wav",
	"cso_edit/skull2_draw.wav",
	"cso_edit/skull2_draw2.wav",
	"cso_edit/skull2_draw3.wav",
	"cso_edit/skull2_draw4.wav",
	"cso_edit/skull2_reload2_1.wav",
	"cso_edit/skull2_reload2_2.wav"
};
...
class weapon_skull2 : CBaseCSOWeapon
{
	...
	void Precache()
	{
		...
		g_Game.PrecacheGeneric( "sprites/cso_edit/weapon_skull2.txt" );
		g_Game.PrecacheGeneric( "sprites/cso_edit/640hud136.spr" );
...
void Register()
{
	...
	g_ItemRegistry.RegisterWeapon( "weapon_skull2", "cso_edit", "357", "", "ammo_357" );
