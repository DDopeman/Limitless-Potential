...
const string BALROG9_MODEL_VIEW			= "models/cso_edit/v_balrog9.mdl";
const string BALROG9_MODEL_PLAYER		= "models/cso_edit/p_balrog9.mdl";
const string BALROG9_MODEL_WORLD		= "models/cso_edit/w_balrog9.mdl";
const string BALROG9_SPRITE_EXP			= "sprites/cso_edit/ef_balrog1.spr";
...
{
	"cso_edit/balrog9_charge_attack.wav",
	"cso_edit/balrog9_charge_finish.wav",
	"cso_edit/balrog9_charge_start.wav",
	"cso_edit/balrog9_draw.wav",
	"cso_edit/balrog9_hit1.wav",
	"cso_edit/balrog9_hit2.wav",
	"cso_edit/skullaxe_wall.wav",
	"cso_edit/balrog9_slash1.wav",
	"cso_edit/balrog9_slash2.wav",
	"cso_edit/balrog9_slash3.wav",
	"cso_edit/balrog9_slash4.wav",
	"cso_edit/balrog9_slash5.wav"
};
...
class weapon_balrog9 : CBaseCSOWeapon
{
	...
	bool LargeSwing( float flDamage )
	{
		...
		if( m_bFullyCharged )
		{
			...
			Vector vecInvPushDir = g_Engine.v_forward * 400.0;
			...
			if ( m_pPlayer.pev.velocity.z >= 600 )
			m_pPlayer.pev.velocity.z = 600;
...
void Register()
{
	...
	g_ItemRegistry.RegisterWeapon( "weapon_balrog9", "cso_edit" );
