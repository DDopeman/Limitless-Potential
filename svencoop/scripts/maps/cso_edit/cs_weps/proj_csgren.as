...
class CCs16Grenade : ScriptBaseMonsterEntity
{
	...
	void Explode( TraceResult pTrace )
	{
		...
		{
			self.pev.origin = pTrace.vecEndPos + (pTrace.vecPlaneNormal * (self.pev.dmg - 24.0f) * 0.3f);
		}
		...
		g_WeaponFuncs.RadiusDamage( self.GetOrigin(), self.pev, pevOwner, self.pev.dmg, self.pev.dmg * 1, CLASS_NONE, DMG_LAUNCH );
