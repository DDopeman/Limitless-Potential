...
// Models
string W_MODEL  	= "models/cso_edit/cs16/ak47/w_ak47.mdl";
string V_MODEL  	= "models/cso_edit/cs16/ak47/v_ak47.mdl";
string P_MODEL  	= "models/cso_edit/cs16/ak47/p_ak47.mdl";
string A_MODEL  	= "models/cso_edit/cs16/ammo/mags.mdl";
int MAG_BDYGRP  	= 12;
// Sprites
...
string SHOOT_S  	= "cso_edit/cs16/ak47/shoot.wav";
// Information
int MAX_CARRY   	= 90;
int MAX_CLIP    	= 30;
...
class weapon_ak47 : ScriptBasePlayerWeaponEntity, CS16BASE::WeaponBase
{
	...
	bool Deploy()
	{
		return Deploy( V_MODEL, P_MODEL, DRAW, "m16", GetBodygroup(), (60.0/30.0) );
	}
	...
	void PrimaryAttack()
	{
		...
		{
			vecSpread = VECTOR_CONE_1DEGREES * 1.04f * (0.06f + (m_iShotsFired * 0.15f));
		}
		else if( m_pPlayer.pev.velocity.Length2D() > 140 )
		{
			vecSpread = VECTOR_CONE_1DEGREES * 1.04f * (0.04f + (m_iShotsFired * 0.115f));
		}
		else
		{
		...
		vecSpread = vecSpread * (m_iShotsFired * 0.125f); // do vector math calculations here to make the Spread worse
		...
		{
			KickBack( 0.75, 0.225, 0.112, 0.025, 3.25, 1.25, 3 );
		}
		else if( !( m_pPlayer.pev.flags & FL_ONGROUND != 0 ) )
		{
			KickBack( 1.0, 0.5, 0.25, 0.175, 4.5, 3.0, 2.0 );
		}
		else if( m_pPlayer.pev.flags & FL_DUCKING != 0 )
		{
			KickBack( 0.45, 0.175, 0.075, 0.012, 2.75, 0.75, 4 );
		}
		else
		{
			KickBack( 0.5, 0.1875, 0.0875, 0.01875, 2.875, 0.875, 4 );
		}
