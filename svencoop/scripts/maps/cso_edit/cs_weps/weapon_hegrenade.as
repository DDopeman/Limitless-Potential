...
// Models
string W_MODEL  	= "models/cso_edit/cs16/he/w_he.mdl";
string W_MODEL2 	= "models/cso_edit/cs16/he/w_he2.mdl";
string V_MODEL  	= "models/cso_edit/cs16/he/v_he.mdl";
string P_MODEL  	= "models/cso_edit/cs16/he/p_he.mdl";
// Sprites
...
string SHOOT_S  	= "cso_edit/cs16/he/throw.wav";
// Information
int MAX_CARRY   	= 5;
...
class weapon_hegrenade : ScriptBasePlayerWeaponEntity, CS16BASE::WeaponBase, CS16BASE::GrenadeWeaponExplode
{
	...
	bool Deploy()
	{
		...
		return Deploy( V_MODEL, P_MODEL, DRAW, "gren", GetBodygroup(), (17.0/30.0) );
	}
	...
	void PrimaryAttack()
	{
		...
		self.m_flNextPrimaryAttack = WeaponTimeBase() + (14.0/21.0);
		self.SendWeaponAnim( PULLPIN, 0, GetBodygroup() );

		m_bInAttack = true;
		m_fAttackStart = g_Engine.time + (14.0/21.0);

		self.m_flTimeWeaponIdle = g_Engine.time + (12.5/25.0) + (23.0/30.0);
	...
	void LaunchThink()
	{
		...
		float flVel = (100.0f - angThrow.x) * 6;
		...
		Vector vecThrow = g_Engine.v_forward * flVel + ( m_pPlayer.pev.velocity * 1.2 );

		CS16GRENADEPROJECTILE::CCs16Grenade@ pGrenade2 = CS16GRENADEPROJECTILE::TossGrenade( m_pPlayer.pev, vecSrc, vecThrow, TIMER, DAMAGE, W_MODEL2 );

		m_pPlayer.m_rgAmmo( self.m_iPrimaryAmmoType, m_pPlayer.m_rgAmmo( self.m_iPrimaryAmmoType ) - 1 );
		g_SoundSystem.EmitSoundDyn( m_pPlayer.edict(), CHAN_WEAPON, SHOOT_S, VOL_NORM, ATTN_NONE, 0, 100 );
		m_fAttackStart = 0;
	}
	...
	void ItemPreFrame()
	{
		...
		self.m_flTimeWeaponIdle = self.m_flNextPrimaryAttack = self.m_flNextSecondaryAttack = self.m_flNextTertiaryAttack = WeaponTimeBase() + (3.0/30.0);
