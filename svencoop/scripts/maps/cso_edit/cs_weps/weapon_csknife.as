...
// Models
string W_MODEL  	= "models/cso_edit/cs16/knf/w_knife.mdl";
string V_MODEL  	= "models/cso_edit/cs16/knf/v_knife.mdl";
string P_MODEL  	= "models/cso_edit/cs16/knf/p_knife.mdl";
// Sprites
string SPR_CAT  	= "melee/"; //Weapon category used to get the sprite's location
// Sounds
string STAB_S   	= "cs16/knf/stab.wav"; //stab
string DEPLOY_S 	= "cso_edit/cs16/knf/draw.wav"; //deploy1
...
array<string> 		KnifeSlashSounds = {
					"cso_edit/cs16/knf/swg1.wav", //slash1
					"cso_edit/cs16/knf/swg2.wav"  //slash2
};
// Information
int MAX_CARRY   	= -1;
...
int WEIGHT      	= 5;
int FLAGS       	= -1;
uint DAMAGE_SLASH 	= 24;
uint DAMAGE_STAB 	= 110;
uint SLOT       	= 0;
uint POSITION   	= 5;
string AMMO_TYPE 	= "";
