...
// Models
string W_MODEL  	= "models/cso_edit/cs16/m4a1/w_m4a1.mdl";
string V_MODEL  	= "models/cso_edit/cs16/m4a1/v_m4a1.mdl";
string P_MODEL  	= "models/cso_edit/cs16/m4a1/p_m4a1.mdl";
...
array<string> 		WeaponSoundEvents = {
					...
					"cs16/m4a1/bltbk.wav",
					"cs16/m4a1/draw.wav",
					"cso_edit/cs16/m4a1/siloff.wav",
					"cs16/m4a1/silon.wav"
};
string SHOOT_S  	= "cs16/m4a1/shoot.wav";
string SHOOT_S2 	= "cso_edit/cs16/m4a1/shoot2.wav";
// Information
int MAX_CARRY   	= 90;
int MAX_CLIP    	= 30;
...
class weapon_m4a1 : ScriptBasePlayerWeaponEntity, CS16BASE::WeaponBase
{
	...
	bool Deploy()
	{
		return Deploy( V_MODEL, P_MODEL, (WeaponSilMode == CS16BASE::MODE_SUP_OFF) ? DRAW_UNSIL : DRAW, "m16", GetBodygroup(), (1.70) );
	}
	...
	void PrimaryAttack()
	{
		...
		{
				vecSpread = VECTOR_CONE_1DEGREES * 1.25;
		}
		else
		{
				vecSpread = VECTOR_CONE_1DEGREES * 0;
		}
		...
		{
			self.m_flNextPrimaryAttack = WeaponTimeBase() + RPM + 0.028;
			self.m_flTimeWeaponIdle = WeaponTimeBase() + 1.0f;
	...
	void Reload()
	{
		...
		Reload( MAX_CLIP, (WeaponSilMode == CS16BASE::MODE_SUP_OFF) ? RELOAD_UNSIL : RELOAD, (2.38), GetBodygroup() );
