...
const float CSOW_TIME_SKILL_LOOP		= 7.5;


const string MODEL_VIEW						= "models/cso_edit/v_dualsword.mdl";
const string MODEL_PLAYER_A				= "models/cso_edit/p_dualsword_a.mdl";
const string MODEL_PLAYER_B				= "models/cso_edit/p_dualsword_b.mdl";
const string MODEL_WORLD					= "models/cso_edit/w_dualsword.mdl";
const string MODEL_SLASH						= "models/cso_edit/dualswordfx.mdl";
const string MODEL_SKILL						= "models/cso_edit/dualsword_skill.mdl";
const string MODEL_SKILLFX1					= "models/cso_edit/dualsword_skillfx1.mdl";
const string MODEL_SKILLFX2					= "models/cso_edit/dualsword_skillfx2.mdl";

const string SPRITE_HIT_STAB1				= "sprites/cso_edit/leaf01_dualsword.spr";
const string SPRITE_HIT_STAB2				= "sprites/cso_edit/leaf02_dualsword.spr";
const string SPRITE_HIT_SLASH1			= "sprites/cso_edit/petal01_dualsword.spr";
const string SPRITE_HIT_SLASH2			= "sprites/cso_edit/petal02_dualsword.spr";
...
{
	"cso_edit/dualsword_fly1.wav",
	"cso_edit/dualsword_fly2.wav",
	"cso_edit/dualsword_fly3.wav",
	"cso_edit/dualsword_fly4.wav",
	"cso_edit/dualsword_fly5.wav",
	"cso_edit/dualsword_hit1.wav",
	"cso_edit/dualsword_hit2.wav",
	"cso_edit/dualsword_hit3.wav",
	"cso_edit/dualsword_idle_a.wav",
	"cso_edit/dualsword_idle_b.wav",
	"cso_edit/dualsword_skill_end.wav",
	"cso_edit/dualsword_skill_start.wav",
	"cso_edit/dualsword_slash_1.wav",
	"cso_edit/dualsword_slash_2.wav",
	"cso_edit/dualsword_slash_3.wav",
	"cso_edit/dualsword_slash_4.wav",
	"cso_edit/dualsword_slash_4_1.wav",
	"cso_edit/dualsword_slash_4_2.wav",
	"cso_edit/dualsword_stab1.wav",
	"cso_edit/dualsword_stab1_hit.wav",
	"cso_edit/dualsword_stab2.wav",
	"cso_edit/dualsword_stab2_hit.wav",
	"cso_edit/mastercombat_wall.wav",
	"cso_edit/dualsword_slash_end.wav",
	"cso_edit/dualsword_stab_end.wav",
	"cso_edit/dualsword_skill_loop_end.wav"
};
...
class weapon_dualsword : CBaseCSOWeapon
{
	...
	void Precache()
	{
		...
		g_Game.PrecacheGeneric( "sprites/cso_edit/weapon_dualsword.txt" );
		g_Game.PrecacheGeneric( "sprites/cso_edit/640hud162.spr" );
	}
...
void Register()
{
	...
	g_ItemRegistry.RegisterWeapon( "weapon_dualsword", "cso_edit" );
