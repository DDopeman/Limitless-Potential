...
const float CSOW_DAMAGE					= 350; //145
const float CSOW_TIME_DELAY1			= 1.55;
const float CSOW_TIME_DELAY2			= 0.3;
const float CSOW_TIME_DRAW			= 1.0;
const float CSOW_TIME_IDLE				= 60.0;
const float CSOW_TIME_RELOAD			= 3.00;
...
const string MODEL_VIEW					= "models/cso_edit/m95/v_m95.mdl";
const string MODEL_PLAYER				= "models/cso_edit/m95/p_m95.mdl";
const string MODEL_WORLD				= "models/cso_edit/m95/w_m95.mdl";
const string MODEL_SHELL				= "models/cso_edit/rshell_big.mdl";
const string MODEL_AMMO					= "models/cso_edit/sniper_ammo.mdl";
...
const array<string> pCSOWSounds =
{
	...
	"cso_edit/zoom.wav",
	"cso_edit/m95-1.wav",
	"cso_edit/m95_boltpull.wav",
	"cso_edit/m95_clipin.wav",
	"cso_edit/m95_clipout.wav"
};
...
class weapon_m95 : CBaseCSOWeapon
{
	...
	void Precache()
	{
		...
		g_Game.PrecacheGeneric( "sprites/cso_edit/weapon_m95.txt" );
		...
		g_Game.PrecacheGeneric( "sprites/cso_edit/muzzleflash4.spr" );
	}
	...
	void M95Fire( float flSpread, float flCycleTime )
	{
		...
		FireBullets3( vecSrc, g_Engine.v_forward, flSpread * 0, iPenetration, BULLET_PLAYER_338MAG, CSOW_TRACERFREQ, flDamage, 1, CSOF_ALWAYSDECAL|CSOF_ARMORPEN );
...
class ammo_cso_sniper : ScriptBasePlayerAmmoEntity
{
	void Spawn()
	{ 
...
void Register()
{
	...
	g_CustomEntityFuncs.RegisterCustomEntity( "cso_m95::ammo_cso_sniper", "ammo_cso_sniper" );
	g_CustomEntityFuncs.RegisterCustomEntity( "cso_m95::weapon_m95", "weapon_m95" );
	g_ItemRegistry.RegisterWeapon( "weapon_m95", "cso_edit", "cso_sniper", "", "ammo_cso_sniper" ); //"50bmg", "", "ammo_50bmg"
}
