...
const string MODEL_VIEW								= "models/cso_edit/v_m3.mdl";
const string MODEL_PLAYER							= "models/cso_edit/p_m3.mdl";
const string MODEL_WORLD							= "models/cso_edit/w_m3.mdl";
...
const array<string> pCSOWSounds =
{
	...
	"cso_edit/m3-1.wav",
	"cso_edit/m3_insertshell.wav",
	"cso_edit/m3_pump.wav"
};
...
class weapon_m3 : CBaseCSOWeapon
{
	...
	void Precache()
	{
		...
		g_Game.PrecacheGeneric( "sprites/cso_edit/640hud1.spr" );
		g_Game.PrecacheGeneric( "sprites/cso_edit/640hud4.spr" );
...
void Register()
{
	g_CustomEntityFuncs.RegisterCustomEntity( "cso_m3::ammo_buckshotb", "ammo_buckshotb" );
	g_CustomEntityFuncs.RegisterCustomEntity( "cso_m3::weapon_m3", CSOW_NAME );
	g_ItemRegistry.RegisterWeapon( CSOW_NAME, "cso_edit", "ammo_buckshotb", "", "ammo_buckshotb" );
