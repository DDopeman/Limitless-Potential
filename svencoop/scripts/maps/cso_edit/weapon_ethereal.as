...
const float CSOW_TIME_RELOAD						= 3.15;
const float CSOW_SPREAD_JUMPING				= 0.15;
const float CSOW_SPREAD_RUNNING				= 0.01485;
const float CSOW_SPREAD_WALKING				= 0.01485;
const float CSOW_SPREAD_STANDING				= 0.01418;
...
const string MODEL_VIEW							= "models/cso_edit/ethereal/v_ethereal.mdl";
const string MODEL_PLAYER						= "models/cso_edit/ethereal/p_ethereal.mdl";
const string MODEL_WORLD						= "models/cso_edit/ethereal/w_ethereal.mdl";
const string MODEL_AMMO							= "models/cso_edit/ethereal/w_etherammo.mdl";
...
const array<string> pCSOWSounds =
{
	...
	"cso_edit/ethereal-1.wav",
	"cso_edit/ethereal_draw.wav",
	"cso_edit/ethereal_reload.wav"
};
...
class weapon_ethereal : CBaseCSOWeapon
{
	...
	void Precache()
	{
		...
		g_Game.PrecacheGeneric( "sprites/cso_edit/640hud74.spr" );
	}
...
class ammo_ether : ScriptBasePlayerAmmoEntity
{
	...
	{ 
		...
		if( pOther.GiveAmmo( iGive, "etherealammo", CSOW_MAX_CARRY ) != -1)
		{
...
void Register()
{
	g_CustomEntityFuncs.RegisterCustomEntity( "cso_ethereal::ammo_ether", "ammo_ether" );
	
	g_CustomEntityFuncs.RegisterCustomEntity( "cso_ethereal::weapon_ethereal", CSOW_NAME );
	g_ItemRegistry.RegisterWeapon( CSOW_NAME, "cso_edit", "etherealammo", "", "ammo_ether" ); //"ether", "", "ammo_ether"
