...
const string MODEL_VIEW				= "models/cso_edit/v_firevulcan.mdl";
const string MODEL_PLAYER			= "models/cso_edit/p_firevulcan.mdl";
const string MODEL_WORLD			= "models/cso_edit/w_firevulcan.mdl";
...
const array<string> pCSOWSounds =
{
	...
	"cso_edit/gatlingm-1.wav",
	"cso_edit/gatling_boltpull.wav",
	"cso_edit/gatling_clipin1.wav",
	"cso_edit/gatling_clipin2.wav",
	"cso_edit/gatling_clipout1.wav",
	"cso_edit/gatling_clipout2.wav",
	"cso_edit/usas_draw.wav"
};
...
class weapon_volcano : CBaseCSOWeapon
{
	...
	void Precache()
	{
		...
		g_Game.PrecacheGeneric( "sprites/cso_edit/weapon_volcano.txt" );
		g_Game.PrecacheGeneric( "sprites/cso_edit/640hud7.spr" );
		g_Game.PrecacheGeneric( "sprites/cso_edit/640hud121.spr" );
