...
const int CSOW_MAX_AMMO					= 140;
const int CSOW_TRACERFREQ					= 0;
const float CSOW_DAMAGE						= 60;
...
const float CSOW_TIME_RELOAD				= 0.5;
const float CSOW_TIME_SWAP				= 0.15;
const float CSOW_SPREAD_JUMPING		= 0.0;
const float CSOW_SPREAD_RUNNING		= 0.0;
const float CSOW_SPREAD_WALKING		= 0.0;
const float CSOW_SPREAD_STANDING		= 0.0;
const float CSOW_SPREAD_DUCKING		= 0.0;

const string CSOW_ANIMEXT					= "onehanded";

const string MODEL_VIEW						= "models/cso_edit/desperado/v_desperado.mdl";
const string MODEL_PLAYER_R				= "models/cso_edit/desperado/p_desperado_m.mdl";
const string MODEL_PLAYER_L				= "models/cso_edit/desperado/p_desperado_w.mdl";
const string MODEL_WORLD					= "models/cso_edit/desperado/w_desperado.mdl";
const string MODEL_AMMO					= "models/cso_edit/desperado/w_desperado_ammo.mdl";
...
class weapon_desperado : CBaseCSOWeapon
{
	...
	void Precache()
	{
		...
		g_Game.PrecacheModel( "sprites/cso_edit/muzzleflash59.spr" );
		g_Game.PrecacheModel( "sprites/cso_edit/muzzleflash60.spr" );
		...
		g_Game.PrecacheGeneric( "sprites/cso_edit/weapon_desperado.txt" );
		g_Game.PrecacheGeneric( "sprites/cso_edit/640hud164.spr" );
...
class ammo_desperado : ScriptBasePlayerAmmoEntity
{
	void Spawn()
	{ 
	...
	{ 
		...
		if( pOther.GiveAmmo( iGive, "cso_desperadoammo", CSOW_MAX_AMMO ) != -1)
		{
...
void Register()
{
	g_CustomEntityFuncs.RegisterCustomEntity( "cso_desperado::ammo_desperado", "ammo_desperado" );
	g_CustomEntityFuncs.RegisterCustomEntity( "cso_desperado::weapon_desperado", "weapon_desperado" );
	g_ItemRegistry.RegisterWeapon( "weapon_desperado", "cso_edit", "cso_desperadoammo", "", "ammo_desperado" ); //.44 Fast Draw
