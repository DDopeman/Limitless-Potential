...
const int PLASMAGUN_SLOT				= 4;
const int PLASMAGUN_POSITION			= 15;
const int BUFFAK_SLOT						= 3;
...
const int M95_SLOT							= 5;
const int M95_POSITION						= 12;
const int SAVERY_SLOT						= 5;
const int SAVERY_POSITION				= 17;
const int M95TIGER_SLOT					= 6;
const int M95TIGER_POSITION			= 19;
const int M400_SLOT							= 5;
const int M400_POSITION					= 13;
...
const string SPRITE_TRAIL_FAILNAUGHT					= "sprites/cso_edit/ef_huntbow_trail.spr";
const string SPRITE_TRAIL_FAILNAUGHT_EXPLODE	= "sprites/cso_edit/ef_huntbow_explo.spr";
