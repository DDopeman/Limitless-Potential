...
void MapInit()
{
	...
	INS2_SKS::DAMAGE = 30;
	INS2_AK12::DAMAGE = 24;
	INS2_MAKAROV::DAMAGE = 20;
	INS2_SAIGA12::DAMAGE = 8;
	INS2_AKM::DAMAGE = 28;
	INS2_AKM::DAMAGE_GL = 150;
	INS2_RPG7::DAMAGE = 200;
	INS2_RPK::DAMAGE = 14;
	INS2_MK2GRENADE::DAMAGE = 140;
	INS2_KABAR::DAMAGE = 72;
	INS2_KNUCKLES::DAMAGE = 40;
	INS2_KUKRI::DAMAGE = 80;
	INS2_AKS74U::DAMAGE = 24;
	INS2_AK74::DAMAGE = 26;
	INS2_PPSH41::DAMAGE = 12;
	INS2_ASVAL::DAMAGE = 20;
	INS2_MOSIN::DAMAGE = 180;
	INS2_SVD::DAMAGE = 120;
	
	//Ammo capacity
	
	INS2_SKS::MAX_CARRY = 600;
	INS2_AKM::MAX_CARRY = 600;
	INS2_RPK::MAX_CARRY = 600;
	
	INS2_AK12::MAX_CARRY = 600;
	INS2_AKS74U::MAX_CARRY = 600;
	INS2_AK74::MAX_CARRY = 600;
	INS2_AN94::MAX_CARRY = 600;
	
	INS2_MAKAROV::MAX_CARRY = 600;
	
	INS2_SAIGA12::MAX_CARRY = 200;
	INS2_ITHACA::MAX_CARRY = 200;
	INS2_M1014::MAX_CARRY = 200;
	INS2_M590::MAX_CARRY = 200;
	
	INS2_AKM::MAX_CARRY2 = 600;
	INS2_GROZA::MAX_CARRY2 = 600;
	
	INS2_RPG7::MAX_CARRY = 10;
	INS2_MK2GRENADE::MAX_CARRY = 10;
	
	INS2_PPSH41::MAX_CARRY = 710;
	
	INS2_GROZA::MAX_CARRY = 300;
	INS2_ASVAL::MAX_CARRY = 300;
	
	INS2_PKM::MAX_CARRY = 200;
	INS2_MOSIN::MAX_CARRY = 200;
	INS2_SVD::MAX_CARRY = 200;
