...
{
    // This may have been named diferently as i don't use it for messages only.
    ...
    // Util for separating strings by quotes
    ...
    // Kinda the same format as ripent
    ...
    // Check in a file, if the given string exists
    ...
    // Opens an external file (ripent formating) and creates the entities. make sure to use at MapInit or precache won't work
    bool LoadEntFile( const string iszFileLoad, string iszClassname = String::INVALID_INDEX )
    {
        ...
        while( !pFile.EOFReached() )
        {
            ...
            if( line[0] == '}' )
            {
                ...
                mk.EntityFuncs.CreateEntity( g_Keyvalues );
